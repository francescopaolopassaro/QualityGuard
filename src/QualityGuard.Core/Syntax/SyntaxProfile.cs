    ...
    bool CaseInsensitive = false)
{
    ...
    private static readonly Dictionary<string, SyntaxProfile> Profiles = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        [LanguageKeys.Swift] = new(StructureStyle.Braces,
            ["func", "init", "deinit", "subscript"],
            ["class", "struct", "enum", "protocol", "extension", "actor"], ["import"], ["let", "var"],
            [.. CFamilyControl, "guard", "repeat", "defer"]),
        ...
        [LanguageKeys.Basic] = new(StructureStyle.EndKeyword,
            ...
            ["dim", "const"],
            ["if", "for", "while", "do", "select", "try", "catch", "finally", "else", "elseif",
             "using", "with", "synclock", "property", "get", "set", "namespace", "operator", "event"],
